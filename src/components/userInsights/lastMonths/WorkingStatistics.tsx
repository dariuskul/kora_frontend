    ...
    <Box maxWidth="40rem" width="100%">
      <Paper>
        <Box borderRadius="0.25rem" padding="1rem 0" bgcolor="white">
          <Typography fontWeight="500" fontSize="1.5rem" mb="1rem" align="center">Monthly summary</Typography>
          <Box width="100%" height="15rem">
            <ResponsiveContainer width="99%" height="100%">
              ...
              >
                ...
                <XAxis padding={{ left: 30, right: 30 }} fontSize="0.875rem" dataKey="month" />
                ...
                <Legend />
                <Line name="Time spent" stroke="#1976d2" dataKey="time" fill="#1976d2" />
              </LineChart>
            </ResponsiveContainer>
          </Box>
        </Box>
