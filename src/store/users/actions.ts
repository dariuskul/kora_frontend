...
import { getAllUsers, loginUser, update } from 'services/auth.service';
import { IUser, LoginUser, RemoveUser, UpdateUser } from 'store/types/User';
...
export const getTeam = createAsyncThunk('User/GET-TEAM', async (_, { rejectWithValue }) => {
  try {
