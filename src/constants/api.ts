...
export const TRACKING_ENDPOINT = {
  ...
  CREATE_TASK: "/tasks",
  EDIT_TASK_TIMER: "/timers/time",
  REMOVE_USER_FROM_PROJECT: "/projects/remove-user",
...
export const ADMIN_ENDPOINT = {
  ...
  GET_USER_PERFORMANCE: (userId: number, projects: Array<number>, from: string, to: string) => `/reports/performance?userId=${userId}&projects=${projects}&from=${from}&to=${to}`,
  GET_CLIENTS: `/clients`,
